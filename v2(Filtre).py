...
class creaWindow(QWidget):
    ...
    def confirmerCreation(self):
        ...
        data.append(self.w1.depot.text())
        data.append(self.w1.regionAdministrative.text() )
        data.append(self.w1.region2022.text())
        data.append(self.w1.statut.text())
        data.append(self.w2.DirecteurRegional.text())
        data.append(self.w2.DirecteurRegionaltelephone.text())
        data.append(self.w2.Directeurdepot.text())
        data.append(self.w2.Directeurdepotmail.text())
        data.append(self.w2.Directeurdepottelephone.text())
        data.append(self.w2.Datedeprisedefonction.text())
        data.append(self.w3.ChefSecurite.text())
        data.append(self.w3.ChefSecuritemail.text())
        data.append(self.w3.ChefSecuriteTelephone.text())
        data.append(self.w3.ChefSecuriteStatut.text())
        data.append(self.w3.DMfileSecurite.text())
        data.append(self.w3.CSReferentSecurite.text())
        data.append(self.w4.ChefLogistique.text())
        data.append(self.w4.ChefLogistiquemail.text())
        data.append(self.w4.ChefLogistiqueTelephone.text())
        data.append(self.w4.ChefLogistiqueStatut.text())
        data.append(self.w4.DMfileLogistique.text())
        data.append(self.w4.CSReferentLogistique.text())
        data.append(self.w5.ChefAmenagement.text())
        data.append(self.w5.ChefAmenagementmail.text())
        data.append(self.w5.ChefAmenagementTelephone.text())
        data.append(self.w5.DMfileAmenagement.text())
        data.append(self.w5.CSReferentAmenagement.text())
        data.append(self.w6.ChefConstruction.text())
        data.append(self.w6.ChefConstructionmail.text())
        data.append(self.w6.ChefConstructionTelephone.text())
        data.append(self.w6.DMfileConstruction.text())
        data.append(self.w6.CSReferentConstruction.text())
        data.append(self.w7.ChefTechnique.text())
        data.append(self.w7.ChefTechniquemail.text())
        data.append(self.w7.ChefTechniqueTelephone.text())
        data.append(self.w7.DMfileTechnique.text())
        data.append(self.w7.CSReferentTechnique.text())
        data.append(self.w8.ChefAdministratif.text())
        data.append(self.w8.ChefAdministratifmail.text())
        data.append(self.w8.ChefAdministratifTelephone.text())
        data.append(self.w8.DMfileAdministratif.text())
        data.append(self.w8.CSReferentAdministratif.text())
        data.append(self.w9.ChefCaisse.text())
        data.append(self.w9.ChefCaissemail.text())
        data.append(self.w9.ChefCaisseTelephone.text())
        data.append(self.w9.DMfileCaisse.text())
        data.append(self.w9.CSReferentCaisse.text())
        data.append(self.w10.ResponsableRH.text())
        data.append(self.w10.ResponsableRHTelephone.text())
        data.append(self.w10.ResponsableCDG.text())
        data.append(self.w10.ResponsableCDGTelephone.text())
        data.append(self.w11.Adresse.text())
        data.append(self.w11.Ville.text())
        data.append(self.w11.Departement.text())
        data.append(self.w11.TELEPHONESTANDARD.text())
        data.append(self.w11.Latitudeendegresdecimaux.text())
        data.append(self.w11.Longitudeendegresdecimaux.text())
        data.append(self.w11.NdegSIREN.text())
        data.append(self.w11.SIRET.text())
        data.append(self.w11.DatedOuverture.text())
        data.append(self.w11.Anciennetedudepot.text())
        data.append(self.w11.Horairedouverturejours1.text())
        data.append(self.w11.Horairedouverturehoraires1.text())
        data.append(self.w11.Horairedouverturejours2.text())
        data.append(self.w11.Horairedouverturehoraires2.text())
        data.append(self.w11.Horairedouverturejours3.text())
        data.append(self.w11.Horairedouverturehoraires3.text())
        data.append(self.w11.AmplitudeHoraire.text())
        data.append(self.w11.CATTC2021.text())
        data.append(self.w11.BASSIN2021.text())
        data.append(self.w11.Cluster2021.text())
        data.append(self.w11.PassagesCaisses2021.text())
        data.append(self.w11.TauxdeDemarque2021.text())
        data.append(self.w11.ETPCDI2021.text())
        data.append(self.w11.ETPCDD2021.text())
        data.append(self.w11.ETPINTERIM2021.text())
        data.append(self.w11.ETPGLOBAL2021.text())
        data.append(self.w11.Formatdepot.text())
        data.append(self.w11.Nombredesites.text())
        data.append(self.w11.ZoneScolaire.text())
        data.append(self.w11.ZonedeDroitSocial.text())
        data.append(self.w11.EntrepotLegacy.text())
        data.append(self.w11.EntrepotEasier.text())
        data.append(self.w11.PlateformeLegacy.text())
        data.append(self.w11.PlateformeEasier.text())
        data.append(self.w11.PlateformeArrivage.text())
        data.append(self.w11.PlateformeArrivageECC.text())
        data.append(self.w11.PlateformederattachementGammeetArrivagesapresouvertures.text())
        data.append(self.w11.GLNPlateformeGamme.text())
        data.append(self.w11.Codeplateforme.text())
        data.append(self.w11.Entrepotdeporte.text())
        data.append(self.w11.OrigineduDepot.text())
        data.append(self.w11.SituationduDepot.text())
        data.append(self.w11.ProprietaireouLocataire.text())
        data.append(self.w12.SurfaceTotaleCDAC.text())
        data.append(self.w12.Surfacedeventeinterieure.text())
        data.append(self.w12.TypedesurfaceSVI.text())
        data.append(self.w12.TypologieSVICourMateriaux.text())
        data.append(self.w12.DistanceCourMateriauxDepot.text())
        data.append(self.w12.SurfaceBati.text())
        data.append(self.w12.TypedesurfaceBati.text())
        data.append(self.w12.TypologieBati.text())
        data.append(self.w12.SurfacedesmateriauxenCDAC.text())
        data.append(self.w12.SURFACEBatienCDAC.text())
        data.append(self.w12.dontLocaldeventeBatienCDAC.text())
        data.append(self.w12.dontGNBensurfacedevente.text())
        data.append(self.w12.dontBatiCouvertenCDAC.text())
        data.append(self.w12.dontBatiNoncouvertenCDAC.text())
        data.append(self.w12.SurfacedelacourmateriauxhorsCDAC.text())
        data.append(self.w12.dontBatiCouverthorsCDAC.text())
        data.append(self.w12.dontBatiNonCouverthorsCDAC.text())
        data.append(self.w12.EmplacementMenuiserie.text())
        data.append(self.w12.ConfigurationMenuiserie.text())
        data.append(self.w12.DistanceMenuiserieDepot.text())
        data.append(self.w12.ShowRoomMenuiserie.text())
        data.append(self.w12.Surfacedelamenuiserie.text())
        data.append(self.w12.dontMenuiserieensurfacedevente.text())
        data.append(self.w12.dontMenuiserieenreserve.text())
        data.append(self.w12.ShowRoomSalledeBains.text())
        data.append(self.w12.Surfacedelareserve.text())
        data.append(self.w12.SurfaceduSas.text())
        data.append(self.w12.Surfacedesbureaux.text())
        data.append(self.w12.Placesdeparking.text())
        data.append(self.w13.FournisseurAgencement.text())
        data.append(self.w13.Nbredenginsdemanutention.text())
        data.append(self.w13.SystemedeGestiondeFlotte.text())
        data.append(self.w14.PCDediesFlexpoint.text())
        data.append(self.w14.NbredecaissesACCUEIL.text())
        data.append(self.w14.NbredecaissesMAGASIN.text())
        data.append(self.w14.NbredeCaissesBATI.text())
        data.append(self.w14.NbredeCaissesGNB.text())
        data.append(self.w14.NbredeCaissesDEPOUILL.text())
        data.append(self.w14.TotalCaisses.text())
        data.append(self.w14.DateRemplacementCaisses.text())
        data.append(self.w14.NbreSCO.text())
        data.append(self.w14.ModeleSCO.text())
        data.append(self.w14.ModeledeTPE.text())
        data.append(self.w14.DateRemplacementTPE.text())
        data.append(self.w15.DotationPDAMotorolaMC75.text())
        data.append(self.w15.PDAMC75Restant012017.text())
        data.append(self.w15.ImprimanteZebra.text())
        data.append(self.w15.PDARelevesdeprix.text())
        data.append(self.w15.RescencemntPDA2019.text())
        data.append(self.w16.Tauxdevolspour100000habitants.text())
        data.append(self.w16.DepotarisquedeVoletnaturedurisque.text())
        data.append(self.w16.TauxdeBraquagepour100000habitants.text())
        data.append(self.w16.Braquages.text())
        data.append(self.w16.Braquagecible.text())
        data.append(self.w16.Tauxdecambriolagepour100000habitants.text())
        data.append(self.w16.Cambriolages.text())
        data.append(self.w16.DontCambriolageducoffre.text())
        data.append(self.w16.TotalEvenements.text())
        data.append(self.w17.TypedeCoffre.text())
        data.append(self.w17.AutomateGLORY.text())
        data.append(self.w17.ModeledeCoffre.text())
        data.append(self.w17.NombredePointsdeRamassageLOOMIS.text())
        data.append(self.w17.PneumatiqueCoffre.text())
        data.append(self.w17.AntennesAntiVol.text())
        data.append(self.w17.VideoCompleteenDepot.text())
        data.append(self.w17.Videodansleslocauxsociaux.text())
        data.append(self.w17.VideoenCaisses.text())
        data.append(self.w17.VideoenLogistique.text())
        data.append(self.w17.VideoauBati.text())
        data.append(self.w17.SocietedeSecurite2019.text())
        data.append(self.w17.Couthoraire2019.text())
        data.append(self.w17.NombredheuresGardiennage2017.text())
        data.append(self.w17.SocietedinterventiondeNuit.text())
        data.append(self.w17.DepotSprinkle.text())
        data.append(self.w17.SystemedeSecuriteIncendie.text())
        data.append(self.w17.ModeledeCentraledAlarme.text())
        data.append(self.w17.InstallateurAlarme1.text())
        data.append(self.w17.InstallateurAlarme2.text())
        data.append(self.w17.Telesurveilleur.text())
        data.append(self.w17.TelesurveilleurTelephone.text())
        data.append(self.w17.GTB.text())
        data.append(self.w17.PortedaccesauxlocauxSociaux.text())
        data.append(self.w17.Controledaccesparbadge.text())
        data.append(self.w17.ControledaccesMigresurserveur.text())
        data.append(self.w17.DATIenMenuiserie.text())
        data.append(self.w17.GenerateurdefumeedansleLocalSecurite.text())
        data.append(self.w17.RalentisseurssurParking.text())
        data.append(self.w17.PlotsantibeliersurParking.text())
        data.append(self.w17.BarrieresdefermetureduParking.text())
        data.append(self.w17.BavoletsLogistique.text())
        data.append(self.w17.EclairageLED.text())
        data.append(self.w17.Ascenseurs.text())
        data.append(self.w18.FacadeROUGE.text())
        data.append(self.w18.RevitalisationRemodling.text())
        data.append(self.w18.DRIVE.text())
        data.append(self.w18.DRIVEdate.text())
        data.append(self.w18.IDepot.text())
        data.append(self.w18.LivraisonLocaleInStore.text())
        data.append(self.w18.LivraisonLocaleInStoreDate.text())
        data.append(self.w18.ZRM.text())
        data.append(self.w18.ZRMDate.text())
        data.append(self.w18.ContenuZRM.text())
        data.append(self.w18.imprimantededieeZRM.text())
        data.append(self.w18.EASIEROULEGACY.text())
        data.append(self.w18.Bacasable.text())
        data.append(self.w18.FournisseurSable.text())
        data.append(self.w18.Tremie.text())
        data.append(self.w18.Godethydraulique.text())
        data.append(self.w18.Godetmecanique.text())
        data.append(self.w18.Betonalatoupie.text())
        data.append(self.w18.chargeuses.text())
        data.append(self.w18.datederetourmails.text())
        data.append(self.w18.IDEPOT.text())
        data.append(self.w18.DecoupeBois.text())
        data.append(self.w18.TestRenfortequipe.text())
        data.append(self.w18.TestsurMesureplacards.text())
        data.append(self.w18.TestsurMesureMenuiserie.text())
        data.append(self.w18.TestTelephoniesurIP.text())
        data.append(self.w18.TestRETENCYTrackingClients.text())
        data.append(self.w18.PresentoiraDalles.text())
        data.append(self.w18.ShowroomSalledeBains.text())
        data.append(self.w18.ShowroomSalledeBainsDate.text())
        data.append(self.w18.Ergosquelette.text())
        data.append(self.w18.Transpaletteciseaux.text())
        data.append(self.w18.Plaquesteflonees.text())
        data.append(self.w18.CagesPalettes.text())
        data.append(self.w19.Lesclientspenetrentdanslazonedesbureauxpouraccederauxtoilettes.text())
        data.append(self.w19.SocietedeNettoyage.text())
        data.append(self.w19.Fenetresaletagedesbureaux.text())
        data.append(self.w19.ComptageClients.text())
        data.append(self.w19.ContexteComptageTCUENTO.text())
        data.append(self.w20.NdegTVA.text())
        data.append(self.w20.NdegCommercant.text())
        data.append(self.w20.CodeAbonneTransax.text())
        data.append(self.w20.CodeVendeurCACF.text())
        data.append(self.w20.CodeIPCACF.text())
        data.append(self.w20.NdegCommercantdrive.text())
        data.append(self.w20.NdegCommercantPayementsanscontact.text())
        data.append(self.w20.CodeIBANBNP.text())
        data.append(self.w21.CompteIdentifiant.text())
        data.append(self.w21.Motdepasse.text())
        data.append(self.w22.TauxdAT2015.text())
        data.append(self.w22.TauxdAT2016.text())
        data.append(self.w22.TauxdAT2017.text())
        data.append(self.w22.TauxdAT2018.text())
        data.append(self.w22.TauxdAT2019.text())
        data.append(self.w22.TauxdAT2020.text())
        data.append(self.w22.TauxdAT2021.text())
...
class surface(QWidget):
    def __init__(self):
        ...
        self.labelTypologieSVICourMateriaux = QLabel("Typologie SVI Cour Matériaux")
        self.TypologieSVICourMateriaux = QLineEdit()
        self.TypologieSVICourMateriaux.setPlaceholderText("Typologie SVI Cour Matériaux")
        ...
        self.layout.addWidget(self.labelTypologieSVICourMateriaux, 4, 0)
        self.layout.addWidget(self.TypologieSVICourMateriaux, 4, 1, 1, 2)
        self.layout.addWidget(self.labelDistanceCourMateriauxDepot, 5, 0)
        self.layout.addWidget(self.DistanceCourMateriauxDepot, 5, 1, 1, 2)
        self.layout.addWidget(self.labelSurfaceBati, 6, 0)
        self.layout.addWidget(self.SurfaceBati, 6, 1, 1, 2)
        self.layout.addWidget(self.labelTypedesurfaceBati, 7, 0)
        self.layout.addWidget(self.TypedesurfaceBati, 7, 1, 1, 2)
        self.layout.addWidget(self.labelTypologieBati, 8, 0)
        self.layout.addWidget(self.TypologieBati, 8, 1, 1, 2)
        self.layout.addWidget(self.labelSurfacedesmateriauxenCDAC, 9, 0)
        self.layout.addWidget(self.SurfacedesmateriauxenCDAC, 9, 1, 1, 2)
        self.layout.addWidget(self.labelSURFACEBatienCDAC, 10, 0)
        self.layout.addWidget(self.SURFACEBatienCDAC, 10, 1, 1, 2)
        self.layout.addWidget(self.labeldontLocaldeventeBatienCDAC, 11, 0)
        self.layout.addWidget(self.dontLocaldeventeBatienCDAC, 11, 1, 1, 2)
        self.layout.addWidget(self.labeldontGNBensurfacedevente, 12, 0)
        self.layout.addWidget(self.dontGNBensurfacedevente, 12, 1, 1, 2)
        self.layout.addWidget(self.labeldontBatiCouvertenCDAC, 13, 0)
        self.layout.addWidget(self.dontBatiCouvertenCDAC, 13, 1, 1, 2)
        self.layout.addWidget(self.labeldontBatiNoncouvertenCDAC, 14, 0)
        self.layout.addWidget(self.dontBatiNoncouvertenCDAC, 14, 1, 1, 2)
        self.layout.addWidget(self.labelSurfacedelacourmateriauxhorsCDAC, 15, 0)
        self.layout.addWidget(self.SurfacedelacourmateriauxhorsCDAC, 15, 1, 1, 2)
        self.layout.addWidget(self.labeldontBatiCouverthorsCDAC, 16, 0)
        self.layout.addWidget(self.dontBatiCouverthorsCDAC, 16, 1, 1, 2)
        self.layout.addWidget(self.labeldontBatiNonCouverthorsCDAC, 17, 0)
        self.layout.addWidget(self.dontBatiNonCouverthorsCDAC, 17, 1, 1, 2)
        self.layout.addWidget(self.labelEmplacementMenuiserie, 18, 0)
        self.layout.addWidget(self.EmplacementMenuiserie, 18, 1, 1, 2)
        self.layout.addWidget(self.labelConfigurationMenuiserie, 19, 0)
        self.layout.addWidget(self.ConfigurationMenuiserie, 19, 1, 1, 2)
        self.layout.addWidget(self.labelDistanceMenuiserieDepot, 20, 0)
        self.layout.addWidget(self.DistanceMenuiserieDepot, 20, 1, 1, 2)
        self.layout.addWidget(self.labelShowRoomMenuiserie, 21, 0)
        self.layout.addWidget(self.ShowRoomMenuiserie, 21, 1, 1, 2)
        self.layout.addWidget(self.labelSurfacedelamenuiserie, 22, 0)
        self.layout.addWidget(self.Surfacedelamenuiserie, 22, 1, 1, 2)
        self.layout.addWidget(self.labeldontMenuiserieensurfacedevente, 23, 0)
        self.layout.addWidget(self.dontMenuiserieensurfacedevente, 23, 1, 1, 2)
        self.layout.addWidget(self.labeldontMenuiserieenreserve, 24, 0)
        self.layout.addWidget(self.dontMenuiserieenreserve, 24, 1, 1, 2)
        self.layout.addWidget(self.labelShowRoomSalledeBains, 25, 0)
        self.layout.addWidget(self.ShowRoomSalledeBains, 25, 1, 1, 2)
        self.layout.addWidget(self.labelSurfacedelareserve, 26, 0)
        self.layout.addWidget(self.Surfacedelareserve, 26, 1, 1, 2)
        self.layout.addWidget(self.labelSurfaceduSas, 27, 0)
        self.layout.addWidget(self.SurfaceduSas, 27, 1, 1, 2)
        self.layout.addWidget(self.labelSurfacedesbureaux, 28, 0)
        self.layout.addWidget(self.Surfacedesbureaux, 28, 1, 1, 2)
